...
Scattering wavelets are interpreted from \acrfull{mfsc} which are the Mel filters without applying the \acrshort{idft} or the \acrshort{dct}.In this section reference is made to \citep{anden2011multiscale, anden2014deep, zeghidour2016deep} for the scattering wavelet definition. 
