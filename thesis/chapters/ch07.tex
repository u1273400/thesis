...
\textcolor{blue}{Although this sequence model design follows the synchronous \acrshort{mimo} design described in Section \ref{sec_postalign}, as a result of the CTC-decoder implementation in Section.  This converts this model from a synchronous \acrshort{mimo} to an asynchronous one.}
...
\section{CTC Decoding} \label{sec_c7_ctc_decoder}
