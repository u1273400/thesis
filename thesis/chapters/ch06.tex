...
GRU RNN 3-layer model (GPU training) & 238.720 && N/A \\
GRU RNN 3-layer model (GPU training) & ~ 2 hours & 30.920 & 75 \\
\bottomrule
\end{tabular}
\end{table}
